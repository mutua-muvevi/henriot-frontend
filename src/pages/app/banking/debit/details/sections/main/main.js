...
const StyledDebitDetailsMainCard = styled(Card)(({ theme }) => ({
	minHeight: 600,
	marginTop: -30
}));

const StyledDebitDetailsMainCardContent = styled(CardContent)(({ theme }) => ({
	marginTop: 30
}));
...
const DebitDetailsMain = () => {
	...
	return (
		<StyledDebitDetailsMainCard>
			<StyledDebitDetailsMainCardContent>
				<StyledTopMain>
					<Button
						variant="contained"
						color="primary"
...
export default DebitDetailsMain