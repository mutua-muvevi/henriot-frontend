...
const StyledDebitHistoryMainCard = styled(Card)(({ theme }) => ({
	minHeight: 600,
	marginTop: -30
}));

const StyledDebitHistoryMainCardContent = styled(CardContent)(({ theme }) => ({
	marginTop: 30
}));
...
const DebitHistoryMain = () => {
	...
	return (
		<StyledDebitHistoryMainCard>
			<StyledDebitHistoryMainCardContent>
				<StyledTopMain>
					<Button
						variant="contained"
						color="primary"
...
export default DebitHistoryMain